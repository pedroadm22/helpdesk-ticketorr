...
--> statement-breakpoint
CREATE UNIQUE INDEX `ticket_statuses_name_unique` ON `ticket_statuses` (`name`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `status_chamado_name_unique` ON `status_chamado` (`name`);